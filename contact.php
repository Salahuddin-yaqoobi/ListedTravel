...
<head>
	...
	<title>Contact - Listed Transport</title>
				...
				<div class="row">
					<div class="contact_frm_area text-left col-lg-6 col-md-12 col-xs-12">
						...
						<form id="contactForm" action="contactform.php" method="POST">
							<div class="form-row">
								<div class="form-group col-sm-6"><input type="text" name="name" class="form-control" placeholder="Name*" required /></div>
								<div class="form-group col-sm-6"><input type="email" name="email" class="form-control" placeholder="Email*" required /></div>
							</div>
							...
							<div class="input-area submit-area" ><button class="btn border-btn"  style="background-color: #28425B !important; color: white; border-color: #ffffff;" type="submit">Send Message</button></div>
